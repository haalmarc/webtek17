...
function translateGoogle(){
    ...
    console.log(translateElement + " " + header + " " + body);
    ...
    })(); // Code from Google ends here
    googleTranslateElementInit()
}

document.getElementById("engelsk").addEventListener("click", translateGoogle);